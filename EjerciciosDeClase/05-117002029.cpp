...
int main()
{
	...
	Goddard_M = Model();
	Goddard_M.LoadModel("Models/cuerpo_goddard.fbx");
	Mandibula = Model();
	Mandibula.LoadModel("Models/mandibula.fbx");
	Pata1 = Model();
	Pata1.LoadModel("Models/pata_d1.fbx");
	Pata2 = Model();
	Pata2.LoadModel("Models/pata_d2.fbx");
	Pata3 = Model();
	Pata3.LoadModel("Models/pata_t1.fbx");
	Pata4 = Model();
	Pata4.LoadModel("Models/pata_t2.fbx");
	...
	while (!mainWindow.getShouldClose())
	{
		...
		*/
		...
		color = glm::vec3(0.0f, 0.0f, 1.0f); 
		glm::mat4 modelMandibula = model; // Empezamos desde la posición del padre
		
		// Mandíbula
		modelMandibula = glm::translate(modelMandibula, glm::vec3(2.95f, 0.5f, -0.70f));
		modelMandibula = glm::rotate(modelMandibula, glm::radians(mainWindow.getarticulacion1()), glm::vec3(0.0f, 0.0f, 1.0f));
		...
		modelPata1 = glm::translate(modelPata1, glm::vec3(0.75f, -0.22f, 0.7f));
		modelPata1 = glm::rotate(modelPata1, glm::radians(mainWindow.getarticulacion2()), glm::vec3(0.0f, 0.0f, 1.0f));
		...
		modelPata3 = glm::translate(modelPata3, glm::vec3(-0.75f, -1.05f, 0.7f));
		modelPata3 = glm::rotate(modelPata3, glm::radians(mainWindow.getarticulacion3()), glm::vec3(0.0f, 0.0f, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(modelPata3));
		Pata3.RenderModel();

		// Pata Delantera Izquierda 
		glm::mat4 modelPata2 = model; 
		modelPata2 = glm::translate(modelPata2, glm::vec3(0.75f, -0.38f, -0.7f));
		modelPata2 = glm::rotate(modelPata2, glm::radians(mainWindow.getarticulacion4()), glm::vec3(0.0f, 0.0f, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(modelPata2));
		Pata2.RenderModel();

		// Pata Trasera Izquierda
		glm::mat4 modelPata4 = model;
		modelPata4 = glm::translate(modelPata4, glm::vec3(-0.75f, -1.15f, -0.7f));
		modelPata4 = glm::rotate(modelPata4, glm::radians(mainWindow.getarticulacion5()), glm::vec3(0.0f, 0.0f, 1.0f));
