...
int main()
{
	...
	*/
	...
	glm::mat4 otromodel(1.0);//Inicializar matriz de Modelo 4x4
	...
	//rotaci�n alrededor de la articulaci�n que une con la cabina
		...
		meshList[0]->RenderMesh();
		 ...
		 // Pir�mide cuadrangular debajo de la cabina
		glm::mat4 modelPiramide = modelCabina;
		modelPiramide = glm::translate(modelPiramide, glm::vec3(0.0f, -2.0f, 0.0f));
		modelPiramide = glm::scale(modelPiramide, glm::vec3(5.0f, 1.0f, 3.0f));
		...
		// Posiciones relativas a la base
		float baseY = 5.5f - 2.0f;
		float baseZ = -4.0f;
		float offsetX = 2.5f;
		float offsetZ = 1.5f;
		float ruedaRadio = 0.5f;
		float ruedaAncho = 0.3f;

		// --- RUEDAS ---
		// Cambiamos la orientación para que las ruedas sean paralelas al plano XY
		// y giren sobre el eje Z.

		// Rueda 1: Frente izquierdo -> usa articulacion5
		modelRueda = glm::mat4(1.0f);
		modelRueda = glm::translate(modelRueda, glm::vec3(-offsetX, baseY - ruedaRadio, baseZ + offsetZ));
		// 2. Animación de giro: ahora sobre el eje Z
		modelRueda = glm::rotate(modelRueda, glm::radians(mainWindow.getarticulacion5()), glm::vec3(0.0f, 0.0f, 1.0f));
		// 3. Orientación: rotamos 90 grados sobre el eje X para alinear el eje de la rueda con Z
		modelRueda = glm::rotate(modelRueda, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		modelRueda = glm::scale(modelRueda, glm::vec3(1.0f, ruedaAncho, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(modelRueda));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[2]->RenderMeshGeometry();

		// Rueda 2: Frente derecho -> usa articulacion6
		modelRueda = glm::mat4(1.0f);
		modelRueda = glm::translate(modelRueda, glm::vec3(offsetX, baseY - ruedaRadio, baseZ + offsetZ));
		modelRueda = glm::rotate(modelRueda, glm::radians(mainWindow.getarticulacion6()), glm::vec3(0.0f, 0.0f, 1.0f));
		modelRueda = glm::rotate(modelRueda, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		modelRueda = glm::scale(modelRueda, glm::vec3(1.0f, ruedaAncho, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(modelRueda));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		...
		// Rueda 3: Trasero izquierdo -> usa articulacion7
		modelRueda = glm::mat4(1.0f);
		modelRueda = glm::translate(modelRueda, glm::vec3(-offsetX, baseY - ruedaRadio, baseZ - offsetZ));
		modelRueda = glm::rotate(modelRueda, glm::radians(mainWindow.getarticulacion7()), glm::vec3(0.0f, 0.0f, 1.0f));
		modelRueda = glm::rotate(modelRueda, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		modelRueda = glm::scale(modelRueda, glm::vec3(1.0f, ruedaAncho, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(modelRueda));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		...
		// Rueda 4: Trasero derecho -> usa articulacion8
		modelRueda = glm::mat4(1.0f);
		modelRueda = glm::translate(modelRueda, glm::vec3(offsetX, baseY - ruedaRadio, baseZ - offsetZ));
		modelRueda = glm::rotate(modelRueda, glm::radians(mainWindow.getarticulacion8()), glm::vec3(0.0f, 0.0f, 1.0f));
		modelRueda = glm::rotate(modelRueda, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		modelRueda = glm::scale(modelRueda, glm::vec3(1.0f, ruedaAncho, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(modelRueda));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
