...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
		...
		glm::vec3 helicopterPosition = glm::vec3(0.0f + mainWindow.getmuevex2(), 5.0f, 6.0);
		glm::vec3 helicopterFrontLight = helicopterPosition;
		glm::vec3 lightDirection = glm::vec3(0.0f, -1.0f, 0.0f);
		spotLights[3].SetFlash(helicopterFrontLight, lightDirection);
		...
		//Instancia del coche 
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f + mainWindow.getmuevex(), -1.2f, -3.0f));
		modelaux = model;
